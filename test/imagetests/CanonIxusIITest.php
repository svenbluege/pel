...
class CanonIxusIITest extends TestCase
{
    public function testRead(): void
    {
        ...
        $this->assertInstanceOf(PelEntryAscii::class, $entry);
        $this->assertSame('Canon DIGITAL IXUS II', $entry->getValue());
        $this->assertSame('Canon DIGITAL IXUS II', $entry->getText());
        ...
        $this->assertSame('1089488628', $entry->getValue());
        $this->assertSame('2004:07:10 19:43:48', $entry->getText());
        ...
        $this->assertSame('1/30 sec.', $entry->getText());
        ...
        $this->assertSame('157/32 sec. (APEX: 5)', $entry->getText());
        ...
        $this->assertSame('-0.3', $entry->getText());
        ...
        $this->assertSame('107/32', $entry->getText());
        ...
        $this->assertSame('6.7 mm', $entry->getText());
        ...
        $this->assertSame('640000/208', $entry->getText());
        ...
        $this->assertSame('480000/156', $entry->getText());
        ...
        $this->assertSame('2048/2048', $entry->getText());
        ...
        $this->assertInstanceOf(PelEntryAscii::class, $entry);
        $this->assertSame('IMG:DIGITAL IXUS II JPEG', $entry->getValue());
        ...
        $this->assertSame(1202044, $entry->getValue());
